...
class Greedy:
    """
        A class used to implement Greedy algorithm
        ...
        -------
        greedy(self,screen):
            calculates the solution using the greedy algorithm and uses pygame
        greedy_terminal(self):
            calculates the solution using the greedy algorithm and uses terminal to print info
    ...
    def heuristic_calculation(self, game, type):
        if type == 1:
            return game.manhattan_distance()
        elif type == 2:
            return game.attack_diff()
        elif type == 3:
            return game.manhattan_distance() + game.attack_diff()
